 ...
 * @since 22-jan-2005
 */
public class OssFileInputData extends BaseStepData implements StepDataInterface {

	public List<OssFileLine> lineBuffer;
	...
	public OssFileFilterProcessor filterProcessor;
	...
	public OssFileEncodingType encodingType;

	public Map<String, Boolean> rejectedFiles;

	public OssFileInputData() {
		super();

		lineBuffer = new ArrayList<OssFileLine>();
