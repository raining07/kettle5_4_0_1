...
public class OssFileFilter implements Cloneable {
	...
	/**
	 * @param filterPosition The position of the occurrence of the filter string to
	 *                       check at
	 * @param filterString   The string to filter on
	 * @param filterLastLine True if we want to stop when we reach a filter string
	 *                       on the specified position False if you just want to
	 *                       skip the line.
	 * @param filterPositive True if we want to get only lines that match this
	 *                       string
	 *
	 */
	public OssFileFilter(int filterPosition, String filterString, boolean filterLastLine, boolean filterPositive) {
