...
/**
 * Processor of Filters. Kind of inversion principle, and to make unit testing
 * easier.
 *
 * @author Sven Boden
 */
public class OssFileFilterProcessor {

	/** The filters to process */
	private OssFileFilter[] filters;
	private boolean stopProcessing;

	/**
	 * @param filters The filters to process
	 */
	public OssFileFilterProcessor(OssFileFilter[] filters) {
	...
	public boolean doFilters(String line) {
		...
		for (int f = 0; f < filters.length && filterOK; f++) {
			OssFileFilter filter = filters[f];
	 ...
	 * false.
	 *
	 * @return == true: processing should stop, == false: processing should
	 *         continue.
	 */
