...
public class OssFileImportWizardPage1 extends WizardPage // implements Listener
{
	...
	public OssFileImportWizardPage1(String arg, PropsUI props, List<String> rows,
		...
		setTitle(BaseMessages.getString(PKG, "OssFileImportWizardPage1.DialogTitle"));
		setDescription(BaseMessages.getString(PKG, "OssFileImportWizardPage1.DialogMessage"));
	}
	...
	public boolean canFlipToNextPage() {
		...
		if (size > 0) {
			...
			setErrorMessage(BaseMessages.getString(PKG, "OssFileImportWizardPage1.ErrorMarkerNeeded"));
			return false;
		}
	}
