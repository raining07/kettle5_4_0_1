...
public class OssVariableButtonListenerFactory {
	...
	public static final SelectionAdapter getSelectionAdapter(final Composite composite, final Text destination,
		...
		return new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				// Before focus is lost, we get the position of where the selected variable
				...
				if (esd.open() != null) {
					...
					if (insertTextInterface == null) {
						...
						// destination.setToolTipText(StringUtil.environmentSubstitute(
						// destination.getText() ) );
						e.doit = false;
					} else {
